...
namespace JamSuite {
    ...
    public static class Physics2D {
        ...
        public static void IgnoreCollision(Rigidbody2D body1, Rigidbody2D body2, bool ignore = true) {
            if(body1 == body2) return;

            Collider2D[] colliders1 = body1.GetComponentsInChildren<Collider2D>();
            Collider2D[] colliders2 = body2.GetComponentsInChildren<Collider2D>();
